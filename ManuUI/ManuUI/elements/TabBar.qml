...
Item {
    ...
    property bool isLargeDevice: Base.Device.type == Base.Device.desktop || Base.Device.type == Base.Device.tablet

    property bool fullWidth: isLargeDevice
            ? false : width - maxTabsWidth <= Base.Units.dp(16) && tabsWidth <= width
    ...
    property int tabPadding: isLargeDevice ? Base.Units.dp(24) : Base.Units.dp(12)

    property int tabMinWidth: isLargeDevice ? Base.Units.dp(160) : Base.Units.dp(72)

    property int selectedIndex: 0

    property bool darkBackground

    property color highlightColor: Base.Theme.tabHighlightColor
    property color textColor: darkBackground ? Base.Theme.dark.textColor : Base.Theme.light.accentColor
    ...
    Component {
        ...
        View {
            ...
            implicitWidth: isLargeDevice
                    ? Math.min(2 * tabPadding + row.width, Base.Units.dp(264))
                    : Math.min(Math.max(2 * tabPadding + row.width, tabMinWidth), Base.Units.dp(264))
                ...
                Row {
                    ...
                    Icon {
                        ...
                        color: tabItem.selected
                                ? darkBackground ? Base.Theme.dark.iconColor : Base.Theme.light.accentColor
                                : darkBackground ? Base.Theme.dark.shade(tab.enabled ? 0.6 : 0.2) : Base.Theme.light.shade(tab.enabled ? 0.6 : 0.2)
                    ...
                    Label {
                        ...
                        color: tabItem.selected
                                ? darkBackground ? Base.Theme.dark.textColor : Base.Theme.light.accentColor
                                : darkBackground ? Base.Theme.dark.shade(tab.enabled ? 0.6 : 0.2) : Base.Theme.light.shade(tab.enabled ? 0.6 : 0.2)
