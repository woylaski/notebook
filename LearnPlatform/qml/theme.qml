...
QtObject {
    ...
    property string primaryColor: 'indigo-500';
    property string backgroundColor: 'white';
    property string accentColor: 'blue-A400';

    //property color  backgroundColor: "transparent";
    property string backgroundImg:   "img/back.jpg";
    property bool   showPageNumber:  true;
