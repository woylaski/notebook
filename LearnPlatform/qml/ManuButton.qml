...
Rectangle {
    ...
    property color defaultColor: ColorVar.colorVars["turquoise"];
    property color pressColor: ColorVar.colorVars["greenSea"];
    property color highlightColor: "#48c9b0";
    property color checkedColor: ColorVar.colorVars["greenSea"]
    ...
    property string fontFamily: FontIconVar.latoRegularFont.name
