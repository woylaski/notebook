...
//http://qutebrowser.org/tmp/qtdoc-linktitle/qml-qtwebkit-webview.html
...
Window {
    ...
    function getDatabase() {
        var db = LocalStorage.openDatabaseSync("Browser", "0.1", "history db", 100000);
        db.transaction(
            function(tx) {
    ...
    Component {
        ...
        WebView {
            ...
            experimental.userScripts: [Qt.resolvedUrl("qrc:/js/qml/js/userscript.js")];
    ...
    Rectangle {
        ...
        Component {
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Image {
                        height: 16; width: 16;
                        source: hasTabOpen ? Tab.itemMap[model.pageid].icon : "qrc:/icons/qml/icons/favicon.png";
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            print("model info ", model.url, model.pageid)
                        }
                    }
        ...
        Component{
            ...
            Rectangle {
                ...
                Text {
                    text: "\uF067";
                    font.family: fontAwesome.name; color: "white"; font.pointSize: 14
        ...
        ListView {
            ...
            //An instance of the header component is created for each view.
            //The header is positioned at the beginning of the view, before any items.
            //The default stacking order of the header is 1.
            //整个view头上的外观设置
            header: viewHeader
            ...
            //The geometry(几何学) of the resulting component instance is managed by the list so as to stay with the current item,
            //unless the highlightFollowsCurrentItem property is false.
            //The default stacking order of the highlight item is 0.
            //选中条目的外观设置
    ...
    Rectangle {
        ...
        //动态加载的虚拟键盘，通过状态state: "show" "hide"来控制显示和隐藏
        Item {
            id: keyboard
            z: 5
            width: 960
        ...
        Item {
            id: backButton
            width: 30; height: 30;
            anchors { top: parent.top; left: drawerButton.right; margins: Tab.DrawerMargin; topMargin: 7}
            Text {
                id: backButtonIcon
                text: "\uF053"
    ...
    Component.onCompleted: {
        //tabModel.insert(0, { "title": "Loading..", "url": "163.com", "pageid": "1", "favicon": "qrc:/icons/qml/icons/favicon.png" } );
        //tabModel.insert(1, { "title": "Loading..", "url": "sina.com", "pageid": "2", "favicon": "qrc:/icons/qml/icons/favicon.png" } );
        //tabModel.append({ "title": "Loading..", "url": "qq.com", "pageid": "3", "favicon": "qrc:/icons/qml/icons/favicon.png" } );
        var db = getDatabase();
