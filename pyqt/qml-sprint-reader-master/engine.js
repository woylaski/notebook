...
//advanced settings
var madvStaticFocalUnicodeCharacter = 'false';
var madvEnableSpaceInsertion = 'false';
var madvRemoveLastSlideNullOrEmpty = 'false';
var madvEnableHyphenatedWordSplit = 'true';
var madvConsolidateHyphenatedWord = 'false';
var madvEnableLongWordHyphenation = 'true';
var madvLongWordTriggerCharacterCount = 'false';
var madvLongWordMinCharacterPerSlidePostSplit = 'false';
var madvLongWordCharacterTriggerDoNotJoin = 'false';
var madvEnableAcronymDetection = 'false';
var madvEnableNumberDecimalDetection = 'false';
var madvDeleteEmptySlides = 'false';
var madvOptimisedPositionLeftMarginPercent = 'false';

var madvWordLengthMinimumSlideDuration = 1;
...
function getTextArray(algorithm, selectedText, chunk) {
    chunkSize = chunk;
...
function splitTextToArray_FirstPass(selectedText) {
    ...
    console.debug(splitText);
    console.debug(splitTextFirstPass);
}
...
function getTextArrayBasic(selectedText, chunkSize) {
	...
	for (var i=0; i < splitText.length; i++) {		
        ...
        textItem.text = textItem.text.trim();
...
function getTextArrayWordLengthTiming(textData) {
	...
	for (var i = 0; i < textData.length; i++) {
		...
		// Enable this to get a log of the textItem
        console.debug("text: " + textData[i].text + " (" + textData[i].predelay + ", " + textData[i].duration + ", " + textData[i].postdelay + ")");
	}
}
...
//	var ftSize = fontSize;
    ...
    var pxOffset = 10; //FIXME

    console.debug('wordToOptimalStart ' + wordToOptimalStart);
    console.debug('wordOptimalLetter ' + wordOptimalLetter);
    //console.debug("pxOptimalLetter " + pxOptimalLetter);
    //console.debug("pxToOptimalStart " + pxToOptimalStart);
    //console.debug("Word: " + textItem.text + " Optimal Letter: " + textItem.optimalletterposition + " Pixel Offset: " + pxOffset);
...
function setSlideShowData(textData) {
    ...
    console.debug("setSlideShowData: "+textData);
