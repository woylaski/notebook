/****************************************************************************
** Meta object code from reading C++ file 'manu_units.h'
**
...
#include "../ManuKnow/src/manu_units.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'manu_units.h' doesn't include <QObject>."
...
void UnitsAttached::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UnitsAttached *_t = static_cast<UnitsAttached *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (UnitsAttached::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UnitsAttached::dpChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (UnitsAttached::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UnitsAttached::multiplierChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject UnitsAttached::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UnitsAttached.data,
      qt_meta_data_UnitsAttached,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *UnitsAttached::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UnitsAttached.stringdata0))
        return static_cast<void*>(const_cast< UnitsAttached*>(this));
